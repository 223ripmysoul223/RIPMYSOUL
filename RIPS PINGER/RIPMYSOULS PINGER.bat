...
title Fire Pinger 
cls
echo _________ad88888888888888888a,
echo ________a88888"888888888888888888,
echo ______,8888"__"P8888888888888888888b,
echo ______d88_________`""P888888888888888,
echo _____,8888b_______________""888888888888,
echo _____d8P'''__,aa,______________""888888888b
echo _____888bbdd888888ba,__,I_________"88888888,
echo _____8888888888888888ba8"_________,8888888b
echo ____,888888888888888888b,________,8888888888
echo ____(88888888888888888888,______,88888888888,
echo ____d888888888888888888888,____,8___"888888b
...
echo ____(8888888888I'888888P'_,8)__________888088
echo _____88888888I"__8888P'__,8")__________880888
echo _____8888888I'___888"___,8"_(._.)_______808888
echo _____(8888I"_____"88,__,8"_____________,8888P
echo ______888I'_______"P8_,8"_____________,88808)
echo _____(88I'__________",8"__M""""""M___,8888988'
echo ____,8I"____________,8(____"aaaa"___,888888
echo ___,8I'____________,888a___________,888888)
...
echo __88888888bbaaaa88XXxxxxxxxxxxXX8)______)8XXxxxxxxXX8"
...
echo _____________.88'____________,_@___________.a8X8,`8,
echo _____________(88____________@@@_________,a8XX88,`8,
echo ____________(888______________@'_______,d8XX8"__"b_`8,
echo ___________.8888,_____________________a8XXX8"____"a__`8,
echo __________.888X88___________________,d8XX8I"______9,__`8,
echo _________.88:8XX8,_________________a8XxX8I'_______`8___`8,
echo ________.88'_8XxX8a_____________,ad8XxX8I'________,8_____`8,
echo ________d8'__8XxxxX8ba,______,ad8XxxX8I"__________8___,___`8,
echo _______(8I___8XxxxxxX888888888XxxxX8I"___________8___II___`8
echo _______8I'___"8XxxxxxxxxxxxxxxxxxX8I'____________(8___8)____8;
echo ______(8I_____8XxxxxxxxxxxxxxxxxX8"_____________(8___8)____8I
echo ______8P'_____(8XxxxxxxxxxxxxxX8I'________________8,__(8____:8
echo _____(8'_______8XxxxxxxxxxxxxxX8'_________________`8,_8_____8
...
echo off
color 3
set /p IP=ENTER The Scrubs IP:
:top
PING -n 1 %IP% | FIND "TTL="                 
IF ERRORLEVEL 1 (SET OUT=9c & echo OFFLINE HO3 ) ELSE (SET OUT=D)
color 3
ping -t 2 5 2 127.0.0.1 >nul
GoTo top
